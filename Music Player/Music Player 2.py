# -*- coding: utf-8 -*-
"""
Created on Mon Jan  3 17:02:30 2022
Music player
@author: tanuj
"""
    ...
    def __init__ (self, master):
        ...
        def create_frames(self):
            ...
            self.tracklist = tk.LabelFrame(self,text=f'Playlist- {len(self.playlist)}',
                        font=("times new roman",15,"bold"),
                        bg= "grey",fg="white",bd=5,relief=tk.GROOVE)
            self.track.configure(width=190, height =400)
            self.track.grid(row=0, column=1,rowspan=3,pady=5)
        ...
        def track_widgets(self):
            ...
            self.configure(width=400, height=240)
